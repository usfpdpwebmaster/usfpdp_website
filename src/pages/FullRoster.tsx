...
const roster = {
  ...
  Rho: {
    ...
    members: [
      ...
      { number: 84, name: 'Brandon Lim', brotherName: 'CLASS WAR', big: 'M #63 - Devin Tran (KNIVES)', little: 'T #94 - Albert Cala (CONQUEROR) & AΓ #136 - Tuan Kiet (Mike) Phan (CHOSEN ONE)' },
      ...
      { number: 86, name: 'Jarrod Van Loon', brotherName: 'LETHAL', big: 'O #77 - Minh Nguyen (KILL SWITCH)', little: 'UNF Associate Chapter Δ #11 - Jonathan (Derin) Gentry (DIVINE DEPARTURE)' },
    ],
  },
  Sigma: {
