...
const roster = {
  Alpha: {
    ...
    members: [
      { number: 1, name: 'Tony Mai', brotherName: 'KidRobot', big: 'Σ Chapter - John Lam (Venom)', little: 'B #16 - Christian Reynes (Rebel Ape) & Δ #20 - Luis Lozano (Falsetto)' },
      { number: 2, name: 'Romel Pancho', brotherName: 'F.E.A.R.', big: 'Σ Chapter - Tri Bui (U.R.B.A.N.)', little: 'Γ #17 - Lam Nguyen (E.L.I.T.E)' },
      { number: 3, name: 'Jonathan Barlaan', brotherName: 'Impound', big: 'Σ Chapter - Peter Nguyen (Rocafella)', little: 'E #27 - Christian Alvarez (Bahamut) & K #53 - Richard Han (The Decision)' },
      { number: 4, name: 'Billy Bui', brotherName: 'Easy Rider', big: 'Σ Chapter - Arif Ahmed (Brick)', little: 'B #11 - Richard Barrido (Bloodlust)' },
      { number: 5, name: 'Don Dau', brotherName: 'Prestige', big: 'Σ Chapter - Loc Le (Thundercat)', little: 'B #12 - Raphael Rivera (Amun-Ra)' },
      { number: 6, name: 'Daniel Lalican', brotherName: 'O.U.T.C.A.S.T.', big: 'Σ Chapter - Alex Ho (N.W.O)', little: 'B #15 - Danny Boyette (D.R.O.I.D.)' },
  ...
  'Alpha Zeta': {
      ...
      members: [
        { number: 144, name: 'Phu Tran', brotherName: 'KIMURA', big: 'AA #126 - Brian Jiang' },
